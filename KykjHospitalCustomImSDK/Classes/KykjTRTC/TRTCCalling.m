...
- (void)call:(NSString *)userID type:(CallType)type roomId:(int)roomid{
    [self call:@[userID] groupID:nil type:type roomId:roomid];
}

- (void)groupCall:(NSArray *)userIDs type:(CallType)type groupID:(NSString *)groupID roomId:(int)roomid {
    [self call:userIDs groupID:groupID type:type roomId:roomid];
}

- (void)call:(NSArray *)userIDs groupID:(NSString *)groupID type:(CallType)type roomId:(int)roomid {
    if (!self.isOnCalling) {
