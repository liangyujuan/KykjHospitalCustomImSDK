...
#define KContentViewY 100.f

#define kDefaultColor RGB(188,188,188)//默认灰色
//黑色
...
- (void)prepare{
    [super prepare];
    self.contentViewY = KContentViewY;
}
- (void)setupSubviews{
    [super setupSubviews];
...
- (void)setSubViewFrame{
    ...
    //有无设置Y坐标值
    if (self.contentViewY == KContentViewY) {
...
- (void)setupTitleLabel:(NSString *)titleStr{
    ...
    UIFont *font = self.titleLabFont.pointSize ? self.titleLabFont : [UIFont systemFontOfSize:16.f];
    CGFloat fontSize = font.pointSize;
    UIColor *textColor = self.titleLabTextColor ? self.titleLabTextColor : RGB(188,188,188);
